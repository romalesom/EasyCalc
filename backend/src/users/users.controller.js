...
const roles_guard_1 = require("../auth/roles.guard"); // ✅ Geändert
...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)('superuser') // ✅ Vereinfacht - nur Superuser für User-Management
    ,
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Roles)('superuser') // ✅ Vereinfacht
    ,
